...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            ...
            if len(opponent_history)==0: #It's the first round: collude
                ...
                recent_round_opponent = opponent_history[-1 or 0 or 1]
                ...
                # no match found
                if history[-1]=='c' and opponent_history[0]=='b' and not random.random()<0.8: #Betray only 60% of the time
                            return 'b' # betray is they were severely punished last time
                else:
                    return 'c' #otherwise collu
    ...
    #
        ...
        if getting_team_name:
            ...
            if len(opponent_history)==0: #It's the first round: collude
                return 'c'
            elif history(opponent_history)=='b' and (history)=='c':
                return 'b' # betray is they were severely punished last time
            elif (opponent_score) ==0 and score== -1:
                return 'c' #otherwise collude
